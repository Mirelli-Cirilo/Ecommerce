...
class CheckoutTemplateViewTestCaseUTils:
...
class CheckoutTemplateViewTestCase(TestCase, CheckoutTemplateViewTestCaseUTils):
    def test_view_is_returning_correct_template(self):
        """
        Should return "loja/Checkout.html" template to every request
        """
